  ...
  return (
    <Page>
      <Content>
        ...
        <p>
          Olá! o Hoco é uma plataforma idealizada por alunos da graduação
          com o objetivo de ajudar os alunos da graduação de ciência da
          computação da Universidade Federal de Campina Grande (UFCG) a
          gerenciarem as suas atividades complementares.
        </p>
        <p>
          A ideia do HoCo é proporcionar uma plataforma unificada onde é
          possível <span>armazenar, visualizar o progresso das suas horas
            complementares, tirar dúvidas acerca do tema</span> e também <span>
            ficar atento quanto às atividades extra-curriculares</span> que o
          curso oferece.
        </p>
        <Subtitle>
          O que preciso ter e fazer para contribuir?
        </Subtitle>
        <p>
        ...
        <Subtitle>
          Pessoas que contribuiram na elaboração do projeto
        </Subtitle>
        <Contributors />
      </Content>
    </Page>
